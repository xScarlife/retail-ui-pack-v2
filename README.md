...
4) Open the ElvUI options menu by writing /ev in your chat window. Go to 'Profiles' and paste in the **[ElvUI Profile String]([https://github.com/xScarlife/retail-ui-pack-v2/blob/main/xScarlife%20ElvUI%20Profile%20V2.txt]())**
