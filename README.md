...
**NOTE 2:** If you are in a dungeon or raid, friendly nameplats will also be active there. By default the friendly nameplates castbar will be shown and can be distracting when raiding. To turn them off please paste in this code in your chat window: /run SetCVar('nameplateShowOnlyNames', 1); ReloadUI()
